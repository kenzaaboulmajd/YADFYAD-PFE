    ...
    <div class="content">
      ...
      <div class="content-area">
        <div class="content-area-header">
          <div class="title">Vérifications des associations</div>
        </div>
        <div class="cards">
          <div class="card card-wide">
            ...
            <div class="card-content">
              <div class="card-filters">
                <input class="card-filter text" id="search" placeholder="Rechercher une association..." autofocus
              ...
              <table class="card-table">
                ...
                <?php foreach ($associations as $association): ?>
                  <tr class="card-table-row">
                    ...
                    <td class="card-table-cell">
                      <span
                        class="card-table-badge <?= $association["VERIFIE"] ? "" : "card-table-badge-danger" ?>"><?= $association["VERIFIE"] ? "Vérifiée" : "Non vérifiée" ?></span>
                    </td>
                    <td class="card-table-cell">
                      <span
                        class="card-table-badge <?= $association["STATUT"] == "EN ATTENTE" ? "card-table-badge-warning" : ($association["STATUT"] == "REFUSE" ? "card-table-badge-danger" : "") ?>">
                        <?= ucfirst(strtolower($association["STATUT"])) ?>
                      </span>
                    </td>
                    <td class="card-table-cell">
